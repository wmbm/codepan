...
def GaussianPredError(error_vector, anomaly_loc, anomaly_dur, thresh = 0.99999, plot = "n"):
    """
    ...
    anomaly_loc : locations of anomalies in simulation or labels from real data
    anomaly_dur : duration of anomalies as defined in the simulations
    thresh : threshold 
